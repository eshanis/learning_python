...
connection = create_server_connection(ipaddress,username,password,"NONE")

print(connection)
# set up the queries
# CREATE THE DATABASE, FORM THE QUERY STRING TO CREATE A NEW DATABASE
create_database_query="CREATE DATABASE testing2"
...
CREATE TABLE {table_name} (
 ...
 """
create_product_table_query=create_product_table.format(table_name=table_name)
